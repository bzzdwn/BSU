...
\begin{document}
    ...
    $$\dfrac{\d \cos x}{\d x} - \cos x|_{x=0} = -1 = -\sqrt2 \sin\left(\dfrac \pi 4 + t\right)|_{t = 0},$$
    $$\cos x|_{x=1} = \cos 1 = \cos(t+1)|_{t=0}.$$
    ...
    Поставленная дифференциальная задача имеет точное решение $$u(x,t) = \cos(x+t).$$
    ...
    \begin{enumerate}
    	...
    	и устойчивую при любых шагах $\tau$, $h$;
    \end{enumerate}
    где $$f(x,t) = \sqrt 2\sin \left(\dfrac \pi 4  - x - t\right),\ \mu_0(t) = \sqrt 2\sin \left(\dfrac \pi 4 + t\right), \beta_0 = 1.$$
    ...
    \begin{enumerate}
    	...
    	\begin{equation}
    		\begin{dcases}
    			...
    			\dfrac \sigma h y_1^{j+1} - \left(\sigma + \dfrac \sigma h + \dfrac{h}{2\tau}\right)y_0^{j+1} = -\dfrac{(1-\sigma)}{h}y_1^j + \left((1-\sigma)\left(\dfrac 1 h + 1\right) - \dfrac{h}{2\tau}\right) y_0^j - \tilde \mu_0(t_{j+1}),\\ y_N^{j+1} = \cos(t_{j+1} + 1),
    		\end{dcases}
    	\end{equation}
...
\PY{k}{def} \PY{n+nf}{u}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{x}\PY{o}{+}\PY{n}{t}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{f}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{4} \PY{o}{\PYZhy{}} \PY{n}{x} \PY{o}{\PYZhy{}} \PY{n}{t}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{mu\PYZus{}0}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{sin}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{4} \PY{o}{+} \PY{n}{t}\PY{p}{)}

\PY{k}{def} \PY{n+nf}{mu\PYZus{}1}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{t} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{diff\PYZus{}scheme\PYZus{}solve}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{h}\PY{p}{,} \PY{n}{tau}\PY{p}{,} \PY{n}{sigma}\PY{p}{,} \PY{n}{u\PYZus{}0}\PY{p}{,} \PY{n}{phi}\PY{p}{,} \PY{n}{mu\PYZus{}01}\PY{p}{,} \PY{n}{mu\PYZus{}1}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        \PY{n}{gamma} \PY{o}{=} \PY{p}{[}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{n}{sigma}\PY{o}{+}\PY{n}{sigma}\PY{o}{/}\PY{n}{h}\PY{o}{+}\PY{n}{h}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{tau}\PY{p}{)}\PY{p}{)}\PY{p}{]}
        \PY{n}{beta} \PY{o}{=} \PY{p}{[}\PY{n}{sigma}\PY{o}{/}\PY{n}{h}\PY{p}{]}
        \PY{n}{g} \PY{o}{=} \PY{p}{[}\PY{o}{\PYZhy{}}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{sigma}\PY{p}{)}\PY{o}{/}\PY{n}{h}\PY{o}{*}\PY{n}{y}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{o}{+}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{sigma}\PY{p}{)}\PY{o}{*}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{/}\PY{n}{h} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{n}{h}\PY{o}{/}\PY{p}{(}\PY{l+m+mi}{2}\PY{o}{*}\PY{n}{tau}\PY{p}{)}\PY{p}{)}\PY{o}{*}\PY{n}{y}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{j}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{mu\PYZus{}01}\PY{p}{(}\PY{n}{t}\PY{p}{[}\PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{]} 
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{h}\PY{p}{,} \PY{n}{x\PYZus{}grid} \PY{o}{=} \PY{n}{generate\PYZus{}grid}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}
\PY{n}{tau}\PY{p}{,} \PY{n}{t\PYZus{}grid} \PY{o}{=} \PY{n}{generate\PYZus{}grid}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{tau} \PY{o}{\PYZlt{}} \PY{n}{h}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2} \PY{o}{/} \PY{l+m+mi}{2}
\end{Verbatim}
\end{tcolorbox}
...
\PY{n}{phi} \PY{o}{=} \PY{n}{f}
\PY{k}{def} \PY{n+nf}{mu\PYZus{}01}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{mu\PYZus{}0}\PY{p}{(}\PY{n}{t}\PY{p}{)} \PY{o}{+} \PY{n}{h}\PY{o}{/}\PY{l+m+mi}{2} \PY{o}{*} \PY{n}{f}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{n}{t}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\end{tcolorbox}
    ...
    Имеем \(\sigma = 0\), \(\tau > h^2 / 2\), то есть разностная схема
должна оказаться неустойчивой
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{n}{h}\PY{p}{,} \PY{n}{x\PYZus{}grid} \PY{o}{=} \PY{n}{generate\PYZus{}grid}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}
\PY{n}{tau}\PY{p}{,} \PY{n}{t\PYZus{}grid} \PY{o}{=} \PY{n}{generate\PYZus{}grid}\PY{p}{(}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{)}
\end{Verbatim}
\end{tcolorbox}
...
\section*{Построение разностной схемы}
Сперва проверим корректную постановку данной дифференциальной задачи, для чего рассмотрим условия согласования:
$$\cos x|_{x=0} = 1 = \cos t|_{t=0},$$
$$-\dfrac{ \d \cos x}{\d x}\Big|_{x=1} = \sin 1 = \sin(t+1)|_{t=0}.$$
Таким образом, условия согласования выполнены. Также для данной задачи выполняется принцип максимума, который позволяет заключить, что если решение задачи существует, то оно единственно. Следовательно, дифференциальная задача является корректно поставленной.\\\\
Поставленная дифференциальная задача имеет точное решение $$u(x,t) = \cos(x+t).$$
Зададим равномерную по каждому направлению сетку
$$\overline\omega_{h\tau} = \overline \omega_h \times \overline \omega_\tau,\ \overline \omega_h = \{x_k = kh,\ k = \overline{0,N},\ Nh = 1\}, \ \overline \omega_\tau = \{t_j = j\tau,\ j=\overline{0,N_1},\ N_1\tau=T\}.$$
...
\begin{equation}
	\begin{cases}
		y_t = \Lambda(\sigma \hat y + (1-\sigma)y)+\varphi,\ (x,t)\in \omega_{h\tau},\\
		y(x,0) = \cos x,\ x \in \overline \omega_h,\\
		y(0,t) = \cos t,\ t \in \overline \omega_\tau,\\ 
		-y_x^{(\sigma)}(1,t) = \sin(t+1),\ t \in \overline \omega_\tau.
	\end{cases}
\end{equation}
...
\PY{k}{def} \PY{n+nf}{f}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{x}\PY{o}{+}\PY{n}{t}\PY{p}{)} \PY{o}{+} \PY{n}{np}\PY{o}{.}\PY{n}{sqrt}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)} \PY{o}{*} \PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{np}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{4} \PY{o}{+} \PY{n}{x} \PY{o}{+} \PY{n}{t}\PY{p}{)}
...
\PY{k}{def} \PY{n+nf}{k}\PY{p}{(}\PY{n}{x}\PY{p}{,}\PY{n}{t}\PY{p}{)}\PY{p}{:}
    \PY{k}{return} \PY{n}{np}\PY{o}{.}\PY{n}{cos}\PY{p}{(}\PY{n}{x}\PY{o}{+}\PY{n}{t}\PY{p}{)} \PY{o}{+} \PY{l+m+mi}{1}
\end{Verbatim}
\end{tcolorbox}
...
\PY{k}{def} \PY{n+nf}{diff\PYZus{}scheme\PYZus{}solve}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{h}\PY{p}{,} \PY{n}{tau}\PY{p}{,} \PY{n}{sigma}\PY{p}{,} \PY{n}{f}\PY{p}{,} \PY{n}{u\PYZus{}0}\PY{p}{,} \PY{n}{mu\PYZus{}0}\PY{p}{,} \PY{n}{mu\PYZus{}1}\PY{p}{,} \PY{n}{k}\PY{p}{)}\PY{p}{:}
    ...
    \PY{k}{for} \PY{n}{j} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{t}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{:}
        ...
        \PY{n}{gamma}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{n}{sigma}\PY{o}{/}\PY{n}{h}\PY{p}{)}
        \PY{n}{g}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{\PYZhy{}}\PY{n}{sigma}\PY{p}{)}\PY{o}{/}\PY{n}{h}\PY{o}{*}\PY{p}{(}\PY{n}{y}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{j}\PY{p}{]} \PY{o}{\PYZhy{}} \PY{n}{y}\PY{p}{[}\PY{n+nb}{len}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{o}{\PYZhy{}}\PY{l+m+mi}{2}\PY{p}{,}\PY{n}{j}\PY{p}{]}\PY{p}{)} \PY{o}{+} \PY{n}{mu\PYZus{}1}\PY{p}{(}\PY{n}{t}\PY{p}{[}\PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)}
        \PY{n}{beta}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}
        \PY{n}{y}\PY{p}{[}\PY{p}{:}\PY{p}{,} \PY{n}{j}\PY{o}{+}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{tridiagonal\PYZus{}algorithm}\PY{p}{(}\PY{n}{alpha}\PY{p}{,}\PY{n}{beta}\PY{p}{,}\PY{n}{gamma}\PY{p}{,}\PY{n}{g}\PY{p}{)}
